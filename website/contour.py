...
# image = cv2.imread("C:/Users/Admin/Desktop/MP2/pan.jpg")
# new_image = image
...
def increase_brightness(img, image, value=30):
...
def final_image(rotated,image):
    ...
    value = int(brightness_value)%100+75
    if value > 100:
        value=85 
    print('Value ',value)
    sharpened=increase_brightness(sharpened,image,value)  
    return sharpened
